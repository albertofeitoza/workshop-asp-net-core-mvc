...
namespace SalesWebMvc.Controllers
{
    public class DepartamentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,Nome,Responsavel")] Departament departament)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Nome,Responsavel")] Departament departament)
        {
